...
public class CustomerStorageImpl implements datalayer.customer.CustomerStorage {
        ...
        try (var con = getConnection();
            ...
            try (var resultSet = stmt.executeQuery()) {
                if (resultSet.next()){
                   ...
                   // var birthdate = resultSet.getDate();
    ...
    public List<Customer> getCustomers() throws SQLException {
        try (var con = getConnection();
            ...
            try (ResultSet resultSet = stmt.executeQuery("select ID, firstname, lastname, birthdate from Customers")) {
