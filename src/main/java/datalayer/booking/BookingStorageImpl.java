...
public class BookingStorageImpl implements BookingStorage {
    ...
    public List<Booking> getBookings() throws SQLException {
        try (var con = getConnection();
            ...
            try (ResultSet resultSet = stmt.executeQuery("select ID, customerId, employeeId, date, start, end from from Bookings")) {
    ...
    public int createBooking(BookingCreation bookingToCreate) throws SQLException {
        ...
        try (var con = getConnection();
            ...
            stmt.setDate(3, (Date) bookingToCreate.getDate());
